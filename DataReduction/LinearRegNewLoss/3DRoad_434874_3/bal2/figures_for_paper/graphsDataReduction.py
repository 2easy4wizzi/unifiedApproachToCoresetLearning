...
def plot_linear_weak(name_color_dict: dict, title: str = '', show_plot: bool = True, solo: bool = False,
    ...
    sgd_ers = [0.00769, 0.01968, 0.00606, 0.01288, 0.00951, 0.00492, 0.00521, 0.00613, 0.00763, 0.00464]
    sgd_std = [0.00692, 0.02746, 0.00735, 0.01310, 0.01036, 0.00548, 0.00741, 0.00570, 0.00830, 0.00502]

    msf_ers = [0.04731, 0.04279, 0.03557, 0.03239, 0.02368, 0.02013, 0.01898, 0.01576, 0.01428, 0.01691]
    msf_std = [0.05054, 0.03530, 0.03684, 0.02750, 0.02041, 0.01689, 0.01595, 0.01262, 0.01126, 0.01605]

    uni_ers = [0.05304, 0.04265, 0.04006, 0.03749, 0.03121, 0.02947, 0.02635, 0.02554, 0.02183, 0.02143]
    uni_std = [0.05611, 0.03457, 0.03410, 0.03669, 0.02793, 0.02437, 0.02140, 0.01890, 0.01960, 0.01759]

    if solo:
        name_color_list = [(name_color_dict['OurCoreset']['name'], name_color_dict['OurCoreset']['color'])]
        save_path = 'linear_weak_solo'
    else:
        name_color_list = [
            ...
            (name_color_dict['Competitor_linear']['name'], name_color_dict['Competitor_linear']['color']),
        ]
        save_path = 'linear_weak'
    ...
    errors_dict[ERR_KEY.format(name_color_dict['Competitor_linear']['name'])] = msf_ers
    errors_dict[STD_KEY.format(name_color_dict['Competitor_linear']['name'])] = msf_std
...
def plot_linear_strong_mean_mean(name_color_dict: dict, title: str = '', show_plot: bool = True, solo: bool = False,
                                 with_zoomed: bool = False):
    """
    ...
    sgd_ers = [0.00004, 0.00013, 0.00004, 0.00012, 0.00007, 0.00006, 0.00004, 0.00006, 0.00006, 0.00006]
    sgd_std = [0.00001, 0.00024, 0.00002, 0.00014, 0.00002, 0.00002, 0.00002, 0.00002, 0.00002, 0.00001]

    # malouf statman feldman
    msf_ers = [0.09303, 0.08500, 0.08710, 0.07821, 0.07511, 0.06983, 0.06798, 0.07090, 0.05495, 0.06200]
    msf_std = [0.04542, 0.04292, 0.04883, 0.03880, 0.03714, 0.03615, 0.03344, 0.03434, 0.02577, 0.03622]

    uni_ers = [0.15692, 0.14224, 0.13588, 0.12738, 0.11501, 0.11691, 0.11024, 0.11149, 0.11293, 0.10120]
    uni_std = [0.11449, 0.08501, 0.08841, 0.09121, 0.08008, 0.07111, 0.08016, 0.07506, 0.07079, 0.06286]

    if solo:
        name_color_list = [(name_color_dict['OurCoreset']['name'], name_color_dict['OurCoreset']['color'])]
        save_path = 'linear_strong_mean_mean_solo'
    else:
        name_color_list = [
            (name_color_dict['OurCoreset']['name'], name_color_dict['OurCoreset']['color']),
            (name_color_dict['Uniform']['name'], name_color_dict['Uniform']['color']),
        ...
        save_path = 'linear_strong_mean_mean'
...
def main():
    name_color = {
        ...
        'Competitor_linear': {
            # 'name': 'LMS-Coreset',
            'name': 'Sensitivity Coreset',
            'color': 'green'
        },
    }
    show_plot = False
    plot_linear_weak(name_color, title='a', show_plot=show_plot, solo=False, with_zoomed=False)
    plot_linear_strong_mean_mean(name_color, title='b', show_plot=show_plot, solo=False, with_zoomed=True)
